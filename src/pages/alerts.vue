    ...
    <v-card-text>
      ...
      <div>
        ...
        <v-alert density="comfortable" type="success" variant="tonal">
          I'm a comfortable alert with the <strong>text</strong> prop and a <strong>type</strong> of
          success
        </v-alert>
        ...
        <v-alert density="default" type="warning">
          I'm a default alert with the <strong>border</strong> prop and a <strong>type</strong> of
          warning
        </v-alert>
      ...
      <div>
        ...
        >
          ...
          lacus. Curabitur ligula sapien, tincidunt non, euismod vitae, posuere imperdiet, leo.
        </v-alert>
